...
export interface IWeeklyPlan {
    name: string,
    dailyPlans?: [DailyPlan, DailyPlan, DailyPlan, DailyPlan, DailyPlan, DailyPlan, DailyPlan],
...
export default model<IWeeklyPlan>('WeeklyPlan', WeeklyPlanSchema, 'weeklyPlans');